		...
		<div class="w3-agileits-our-advantages-grids">
				<div class="col-md-4 w3layouts-our-advantages-grid">
					...
					<div class="col-xs-9 w3l-our-advantages-grd-right">
						<h4>Creative</h4>
						<p>Creative Education brings freedom in learning 
						where students are free to choose what they learn.</p>
				...
				<div class="col-md-4 w3layouts-our-advantages-grid">
					...
					<div class="col-xs-9 w3l-our-advantages-grd-right">
						...
						<p> We encourage students to actively participate
						 in their education for better learning.</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="col-md-4 w3layouts-our-advantages-grid">
					...
					<div class="col-xs-9 w3l-our-advantages-grd-right">
						...
						<p>Education is the process of facilitating learning,
						 or the acquisition of knowledge, skills, & values.</p>
				...
				<div class="col-md-4 w3layouts-our-advantages-grid">
					...
					<div class="col-xs-9 w3l-our-advantages-grd-right">
						...
						<p>Health education motivates students to improve and 
						maintain their physical, mental and social health.</p>
				...
				<div class="col-md-4 w3layouts-our-advantages-grid">
					...
					<div class="col-xs-9 w3l-our-advantages-grd-right">
						...
						<p>students are learning in a safe and supportive 
						learning environment during their course.</p>
				...
				<div class="col-md-4 w3layouts-our-advantages-grid">
					...
					<div class="col-xs-9 w3l-our-advantages-grd-right">
						<h4>Top education</h4>
						<p>Education is what remains after one has forgotten 
							what one has learned in school.</p>
				...
				<ul class="rslides" id="slider1">
					<li>
						...
						<div class="test-monials">
							<p>One of the very important characteristics of a student is to question. Let the students ask questions.</p>
...
<!--sign-up-section-->
	<div class="signup" id="signup">
		...
		<div class="head-top-w3ls"><i class="fa fa-graduation-cap" aria-hidden="true"></i></div>
			...
			<p>Find out how to get involved in programs of students include world-class curriculum and knowledgeable student development professionals that meet the needs of student at every age and stage.</p>
			<div class="button2">
...
<!-- Footer -->
			...
			<div class="copyright-wthree">
				<p>&copy; 2017 Educative . All Rights Reserved | Design by <a href="http://w3layouts.com/"> W3layouts </a></p>
			</div>
<!-- //Footer -->
