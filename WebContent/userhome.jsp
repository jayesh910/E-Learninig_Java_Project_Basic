...
<div id="home">
		...
		<header>
			...
			<nav class="navbar navbar-default">
				...
				<!--  <li>	View courses:<select></select></li>-->
					
					<li class="dropdown">
					  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> View Courses<span class="caret"></span></a>
...
<!-- script-for-menu -->
					...
					<h1 align="center" style="color:red; font-size:80px">Welcome </h1>
